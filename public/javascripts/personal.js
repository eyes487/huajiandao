...
city.options[ii].value = cities[pv][i]; 
    ...
    const a = document.getElementsByClassName("panelwrap")[0];
    function payBtn() {
...
window.onload = function() {
    const personage = document.getElementsByClassName("person-message")[0];
    const Div = document.getElementsByClassName("tab");
    const mt = document.getElementsByClassName("mt-menu-tree")[0].getElementsByTagName("ul")[0];
    const tabLi = mt.getElementsByTagName("li");
